...
def plot_one_box(source, x, img, color=None, label=None, line_thickness=None):
    ...
    if label:
        ...
        #font = ImageFont.truetype('/home/dhruv/app/static/Fonts/arial.ttf', 35)  
        #text = label
        #img = draw.text((c1[0], c1[1]-30), text, font = font, align ="left")  
        #image.save("/home/dhruv/app/static/output/{}".format(source.split("/")[-1]), img)
